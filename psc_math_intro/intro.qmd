...
This document should serve as an introductory primer for new social science students matriculating into a graduate program. In it, I will cover some basic math concepts that are important for understanding probability, statistics, and research design in general. I will also cover some basic research concepts that are important for conducting quantitative research--regardless of what your research interests are.

Given the variation in incoming students' exposure to math and research, I will try to start from as early of a point as possible. If you're already familiar with some of the concepts I cover, feel free to skip ahead. There might also be some concepts I cover that might not be absolutely necessary or that might be more advanced than would be necessary for an introductory course. Any such topics will be designated with an asterisk (\*), indicating that it can be skipped. 

The only background in math I assume will be basic arithmetic; that is, addition, subtraction, multiplication, and division. While I won't go too in-depth into the any one concept, I'll provide as much context as I can to help you be more fluent in the material as you move forward in your studies. In other words, this isn't a probability or statistics textbook, but rather a primer to help you understand the concepts you'll encounter in your classes.[^2] Where possible, I'll point you to resources that can help you learn more about these concepts if they interest you.
...
[^2]: Indeed, this is where the title comes from: this document should hopefully help anyone struggling through what would otherwise be an intro textbook. 